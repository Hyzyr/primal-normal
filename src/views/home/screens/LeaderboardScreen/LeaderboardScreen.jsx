  ...
  return (
    <div className="leaderboard screen">
      ...
      <div className="leaderboard__item _first">
        ...
        <div className="leaderboard__item-text">John Johnson</div>
      </div>
      <div className="leaderboard__item _second">
        ...
        <div className="leaderboard__item-text">Jones Williams</div>
      </div>
      <div className="leaderboard__item _third">
        ...
        <div className="leaderboard__item-text">Michael Brown</div>
      </div>
    </div>
  );
};
